...
var AvalancheFormatter = /*#__PURE__*/function (_Formatter) {
  _inheritsLoose(AvalancheFormatter, _Formatter);

  function AvalancheFormatter() {
    return _Formatter.call(this) || this;
  }

  var _proto = AvalancheFormatter.prototype;
...
var ApiAvalancheProvider = /*#__PURE__*/function (_JsonRpcProvider) {
  _inheritsLoose(ApiAvalancheProvider, _JsonRpcProvider);

  function ApiAvalancheProvider(url) {
    var _this;
  ...
  ApiAvalancheProvider.getNetwork = function getNetwork(network, shardingStructure) {
  ...
  ApiAvalancheProvider.getFormatter = function getFormatter() {
    return new AvalancheFormatter();
  };

  var _proto = ApiAvalancheProvider.prototype;
  ...
  _createClass(ApiAvalancheProvider, [{
    key: "network",
    get: function get() {
  ...
  return ApiAvalancheProvider;
}(JsonRpcProvider);

export { ApiAvalancheProvider, Directive, HRP, AvalancheAddress, getAddress, isBech32Address, isBech32TestNetAddress, parse, parseStakingTransaction, parseTransaction, serialize, serializeStakingTransaction, tHRP };
